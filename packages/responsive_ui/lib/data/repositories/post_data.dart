...
final pietro = PostAuthor("Pietro Maggi", "https://medium.com/@pmaggi");
final manuel = PostAuthor("Manuel Vivo", "https://medium.com/@manuelvicnt");
final florina =
    PostAuthor("Florina Muntenescu", "https://medium.com/@florina.muntenescu");
final jose = PostAuthor("Jose Alcérreca", "https://medium.com/@JoseAlcerreca");

final publication = Publication("Android Developers",
    "https://cdn-images-1.medium.com/max/258/1*u7oZc2_5mrkcFaxkXEyfYA@2x.png");
final paragraphsPost1 = [
  ...
  Paragraph(ParagraphType.Header, "If you cannot remove it, just rename it!"),
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Italic, 41, 72)]),
  Paragraph(
    ParagraphType.Text,
    "In this particular case our settings.gradle becomes:",
    markups: [Markup(MarkupType.Code, 28, 43)],
  ),
  ...
  Paragraph(ParagraphType.Bullet, "On Demand module codelab", markups: [
...
final paragraphsPost2 = [
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Link, 0, 6, href: "https://dagger.dev/")]),
  Paragraph(ParagraphType.Text,
      ...
      markups: [
        Markup(MarkupType.Link, 14, 26, href: "https://dagger.dev/tutorial/"),
  ...
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Code, 41, 53)]),
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Code, 81, 97)]),
  Paragraph(ParagraphType.Text, "Qualifiers for field attributes"),
  Paragraph(ParagraphType.Text, "", markups: [Markup(MarkupType.Link, 0, 0)]),
  Paragraph(ParagraphType.Text,
  ...
  Paragraph(ParagraphType.CodeBlock,
      ...
      markups: [Markup(MarkupType.Bold, 8, 29)]),
  ...
  Paragraph(
      ...
      """
        ...
        """ // trim indent
      ,
      markups: [Markup(MarkupType.Bold, 65, 95)]),
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Code, 18, 24)]),
  ...
  Paragraph(ParagraphType.CodeBlock, """
        ...
        """, // trim indent
      markups: [Markup(MarkupType.Bold, 72, 93)]),
  ...
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Code, 51, 60)]),
  Paragraph(ParagraphType.Text,
  ...
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Code, 185, 194)])
];

final paragraphsPost3 = [
  Paragraph(ParagraphType.Text,
  ...
  Paragraph(ParagraphType.Text, "", markups: [
...
final paragraphsPost4 = [
  ...
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Bold, 183, 197)]),
  Paragraph(ParagraphType.Text,
  ...
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Bold, 73, 133)]),
  Paragraph(ParagraphType.Text,
      ...
      markups: [
        Markup(MarkupType.Link, 3, 9, href: "https://twitter.com/ZelenetS"),
...
final paragraphsPost5 = [
  ...
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Italic, 57, 61)]),
  Paragraph(ParagraphType.Text,
  ...
  Paragraph(
      ...
      "public fun <T, R> Sequence<T>.map(transform: (T) -> R): Sequence<R>{      \n" +
          ...
          "}",
      markups: [Markup(MarkupType.Bold, 85, 105)]),
  Paragraph(ParagraphType.Text,
  ...
  Paragraph(
      ...
      markups: [Markup(MarkupType.Bold, 109, 120)]),
  Paragraph(
      ParagraphType.CodeBlock,
  ...
  Paragraph(ParagraphType.Bullet,
      ...
      markups: [Markup(MarkupType.Code, 0, 10)]),
  Paragraph(ParagraphType.Bullet,
  ...
  Paragraph(ParagraphType.Text,
      ...
      markups: [Markup(MarkupType.Code, 202, 210)]),
  Paragraph(ParagraphType.Text,
...
final post1 = Post(
    ...
    metadata: Metadata(author: pietro, date: "August 02", readTimeMinutes: 1),
    paragraphs: paragraphsPost1,
    imageUrl: "assets/image/post_1.png",
    imageThumbUrl: "assets/image/post_1_thumb.png");
...
final post2 = Post(
    ...
    publication: publication,
    metadata: Metadata(author: manuel, date: "July 30", readTimeMinutes: 3),
    paragraphs: paragraphsPost2,
    imageUrl: "assets/image/post_2.png",
    imageThumbUrl: "assets/image/post_2_thumb.png");
...
final post3 = Post(
    ...
    publication: publication,
    metadata: Metadata(author: florina, date: "July 09", readTimeMinutes: 1),
    paragraphs: paragraphsPost3,
    imageUrl: "assets/image/post_3.png",
    imageThumbUrl: "assets/image/post_3_thumb.png");
...
final post4 = Post(
    ...
    publication: publication,
    metadata: Metadata(author: jose, date: "April 02", readTimeMinutes: 1),
    paragraphs: paragraphsPost4,
    imageUrl: "assets/image/post_4.png",
    imageThumbUrl: "assets/image/post_4_thumb.png");
...
final post5 = Post(
    ...
    publication: publication,
    metadata: Metadata(author: florina, date: "July 24", readTimeMinutes: 4),
    paragraphs: paragraphsPost5,
    imageUrl: "assets/image/post_5.png",
    imageThumbUrl: "assets/image/post_5_thumb.png");

final posts = PostsFeed(
  highlightedPost: post4,
  recommendedPosts: [post1, post2, post3],
  popularPosts: [post5, post1..id = "post6", post2..id = "post7"],
  recentPosts: [post3..id = "post8", post4..id = "post9", post5..id = "post10"],
);
